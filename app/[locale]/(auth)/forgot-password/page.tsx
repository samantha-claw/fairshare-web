    ...
    return (
      ...
      >
        <div className="rounded-3xl border border-border bg-surface p-8 text-center shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-text-primary">{t('auth.forgotPassword.passwordUpdatedTitle')}</h2>
          <p className="mt-3 text-sm leading-relaxed text-text-secondary">
            {t('auth.forgotPassword.passwordUpdatedDesc')}
          </p>
          <Link
            href="/login"
    ...
    return (
      ...
      >
        <div className="rounded-3xl border border-border bg-surface p-8 text-center shadow-lg">
          ...
          <h2 className="text-2xl font-bold text-text-primary">{t('auth.forgotPassword.checkEmailTitle')}</h2>
          <p className="mt-3 text-sm leading-relaxed text-text-secondary">
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 text-center">
        ...
        >
          {isRecoveryMode ? t('auth.forgotPassword.recoveryTitle') : t('auth.forgotPassword.requestTitle')}
        </motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          {isRecoveryMode
            ? t('auth.forgotPassword.recoverySubtitle')
          ...
          <form onSubmit={handleResetSubmit} className="space-y-5">
            <div className="group">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  aria-label={showPassword ? t('auth.forgotPassword.hidePassword') : t('auth.forgotPassword.showPassword')}
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  aria-label={showConfirmPassword ? t('auth.forgotPassword.hidePassword') : t('auth.forgotPassword.showPassword')}
            ...
            >
              {loading ? (
                ...
                <>
                  {t('auth.forgotPassword.updateButton')}
                  <ArrowRight className="h-4 w-4 rtl:rotate-180" />
                </>
              )}
            </button>
