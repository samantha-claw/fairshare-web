  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full rounded-xl border border-border bg-surface py-2.5 ps-4 pe-11 text-sm text-text-primary shadow-sm transition-all duration-200 placeholder:text-text-tertiary focus:border-border-2 focus:outline-none focus:ring-2 focus:ring-border/30 disabled:cursor-not-allowed disabled:opacity-50"
      />
      <button
        type="button"
        onClick={() => setShow((s) => !s)}
          ...
          >
            <div className="border-b border-border px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-text-primary">{t('settings.emailSection')}</h2>
                  <p className="text-xs text-text-secondary">
                    {t('settings.currently')}: <span className="font-medium text-text-primary">{userEmail}</span>
                  </p>
                </div>
              </div>
            </div>
            <form onSubmit={handleEmailUpdate} className="px-6 py-5">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 rounded-lg bg-surface-2 p-3">
                  ...
                  <p className="text-xs text-text-secondary">
                    {t('settings.emailConfirmationNote')}
                  </p>
                </div>
              </div>
          ...
          >
            <div className="border-b border-border px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-text-primary">{t('settings.passwordSection')}</h2>
                  <p className="text-xs text-text-secondary">
            ...
            <form onSubmit={handlePasswordUpdate} className="px-6 py-5">
              <div className="space-y-4">
                ...
                <div id="password-requirements" className="space-y-1.5 rounded-lg bg-surface-2 p-3">
                  <p className="mb-1 text-xs font-semibold text-text-secondary">{t('settings.requirements')}:</p>
          ...
          >
            <div className="border-b border-negative/20 bg-negative-bg/50 px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-text-primary">{t('settings.dangerZone')}</h2>
                  <p className="text-xs text-text-secondary">{t('settings.dangerSubtitle')}</p>
                </div>
              </div>
            </div>
            <div className="px-6 py-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="min-w-0">
                  <h3 className="text-sm font-bold text-text-primary">{t('settings.deleteAccount')}</h3>
