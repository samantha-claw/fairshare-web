                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="relative flex-1 min-w-[150px] max-w-xs">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-border bg-surface py-2 ps-9 pe-3 text-sm text-text-primary placeholder:text-text-tertiary focus:border-border-2 focus:outline-none"
                    />
                  </div>
                  ...
                  <Select value={sortBy} onValueChange={(v: string) => setSortBy(v as SortOption)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="recent">{t('friends.sortByRecent')}</SelectItem>
                    </SelectContent>
                  </Select>
