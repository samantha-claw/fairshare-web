        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-text-secondary">
              {t('dashboard.groups', { count: filteredAndSortedGroups.length })}
            </p>
          </div>
        </div>
        <button
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3">
        ...
        <Select value={sortBy} onValueChange={(v: string) => setSortBy(v as SortOption)}>
          ...
          <SelectContent>
            ...
            <SelectItem value="activity">{t('groups.sortByActivity')}</SelectItem>
            <SelectItem value="cashflow">{t('groups.sortByCashflow')}</SelectItem>
          </SelectContent>
        </Select>
