...
export default async function DashboardPage() {
  ...
  // 3. 🔥 جلب المجموعات الخاصة بالمستخدم (الجزء الجديد المضاف)
    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link
            href="/groups/new" // تأكد أن المسار هنا صحيح لصفحة الإنشاء
        ...
        {/* ── Groups Grid Logic (الجزء المعدل للعرض) ── */}
        {groups.length === 0 ? (
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {groups.map((group: any) => (
              <Link
                key={group.id}
                href={`/groups/${group.id}`} // الرابط لصفحة التفاصيل
              ...
              >
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500 line-clamp-2">
                    {/* يمكنك إضافة وصف هنا لو وجد مستقبلاً */}
