    ...
    <div className="grid gap-4 sm:grid-cols-3">
      ...
      <div className="rounded-xl border border-border bg-surface p-5 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-100 text-text-primary">
      ...
      <div
        className={`rounded-xl border bg-surface p-5 shadow-sm ${
          myNetBalance > 0 ? "border-green-200" : myNetBalance < 0 ? "border-red-200" : "border-border"
        }`}
      >
        <div className="flex items-center gap-3">
          <div
      ...
      <div
        className={`rounded-xl border bg-surface p-5 shadow-sm ${
          pendingCount > 0 ? "border-amber-200" : "border-border"
        }`}
      >
        <div className="flex items-center gap-3">
          <div
            className={`flex h-10 w-10 items-center justify-center rounded-lg ${
              pendingCount > 0 ? "bg-amber-100 text-amber-600" : "bg-surface-2 text-text-secondary"
            }`}
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
