...
interface AddMemberModalProps {
  ...
  // Kept optional so the parent doesn't break — no longer used internally
...
export function AddMemberModal({
  ...
  // ── Local client-side filter (instant, no debounce needed) ──
        ...
        <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl sm:my-8">
          ...
          <div className="border-b border-gray-100 px-6 pb-4 pt-6">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="rounded-md p-1 text-gray-400 transition-all duration-200 hover:bg-gray-100 hover:text-gray-600 active:scale-95"
              >
                <svg
                  className="h-5 w-5"
                  fill="none"
              ...
              <ul className="space-y-2">
                {filteredFriends.map((friend) => (
                  <li
                    ...
                    className="flex items-center justify-between rounded-lg border border-gray-100 bg-gray-50/50 p-3 transition-all hover:border-blue-200 hover:bg-blue-50/30"
                  >
                    <Link
                    ...
                    <button
                      ...
                      className="ml-3 inline-flex shrink-0 items-center gap-1 rounded-md bg-blue-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm transition-all duration-200 hover:bg-blue-700 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                    >
            ...
            {!loadingFriends && invitableFriends.length > 0 && (
              <div className="mt-5 rounded-lg border border-indigo-100 bg-indigo-50/50 px-4 py-3 text-center">
                <p className="text-xs text-indigo-600">
                  ...
                  <br />
                  Use the{" "}
                  <span className="font-semibold">Share / QR Code</span>{" "}
