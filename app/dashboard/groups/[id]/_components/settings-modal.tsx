      ...
      <div className="flex min-h-screen items-end justify-center p-4 text-center sm:items-center sm:p-0">
        ...
        <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl sm:my-8">
          ...
          <div className="px-6 py-6">
            ...
            {isOwner ? (
              <div className="rounded-xl border border-red-200 bg-red-50/50 p-5">
                ...
                >
                  {deletingGroup ? (
                    <span className="inline-flex items-center gap-2"><Spinner className="h-4 w-4" /> Deleting…</span>
                  ) : (
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50/50 p-5">
                ...
                >
                  {leavingGroup ? (
                    <span className="inline-flex items-center gap-2"><Spinner className="h-4 w-4" /> Leaving…</span>
                  ) : (
                    "Leave Group"
                  )}
                </button>
          ...
          <div className="border-t border-gray-100 bg-gray-50 px-6 py-3">
            <button onClick={handleClose} className="w-full rounded-lg py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Close</button>
          </div>
        </div>
      </div>
    </div>
