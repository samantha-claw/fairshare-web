...
export function ProfileHeader({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-border bg-surface shadow-sm">
      {/* ── Banner Gradient ───────────────────────── */}
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-neutral-800 via-neutral-700 to-neutral-600 sm:h-56">
        {/* Decorative Elements */}
